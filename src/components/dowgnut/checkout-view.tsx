...
export function CheckoutView() {
  ...
  const onPlace = async () => {
    ...
    try {
      ...
      const types = cart.map((c) => c.donut.type);  // captured before checkout clears cart
          ...
          <Card className="gap-4 rounded-3xl border-2 border-[var(--color-dowgnut-blue-dark)]/10 bg-[var(--color-dowgnut-cream)] p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input id="phone" type="tel" value={form.customerPhone} onChange={set("customerPhone")} placeholder="012-345 6789" className="h-11 bg-white" />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="h-11 rounded-md border border-[var(--color-dowgnut-blue-dark)]/15 bg-white px-3 text-sm"
                >
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="zip">Postcode * (5 digits)</Label>
                <Input id="zip" value={form.zip} onChange={set("zip")} placeholder="50000" maxLength={5} className="h-11 bg-white" />
              </div>
              <div className="flex flex-col gap-1.5 sm:col-span-2">
        ...
        <Card className="h-fit gap-3 rounded-3xl border-2 border-[var(--color-dowgnut-blue-dark)]/10 bg-white p-5 sm:p-6">
          ...
          <div className="mt-2 space-y-1 border-t border-[var(--color-dowgnut-blue-dark)]/10 pt-3 text-sm">
            ...
            <div className="flex items-center justify-between text-[var(--color-dowgnut-blue-dark)]/80">
              ...
              <span className="font-semibold">{delivery === 0 ? "FREE" : `RM${delivery.toFixed(2)}`}</span>
            </div>
            <div className="flex justify-between text-[var(--color-dowgnut-blue-dark)]/80">
              <span>SST (6%)</span>
